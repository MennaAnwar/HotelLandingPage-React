...
export default function Contact() {
  return (
    <div id="contact">
      <footer>
        <div className="custom-shape-divider-bottom-1674754848">
          <svg
            data-name="Layer 1"
        ...
        <div id="footer-content">
              ...
              <div className="col-lg-8 col-md-12">
                <div className="d-flex flex-column bd-highlight mb-3">
                  <div className="p-2 bd-highlight">
                    <i className="bx bxs-phone"></i>+xx xx xxx xxxx
                  </div>
                  <div className="p-2 bd-highlight">
                    <i className="bx bxs-location-plus">
                      xxxx St. Name, City, Country
                    </i>
                  </div>
                  <div className="p-2 bd-highlight d-flex justify-content-evenly">
          ...
          <p className="text-center text-muted mb-0">© 2023 Company, Inc</p>
        </div>
      </footer>
    </div>
  );
